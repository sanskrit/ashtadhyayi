...
---
The affixes _chvi_ and _dach_ are ordained when the verb in composition is either कृ, भू or अस् (5.4.50) and (5.4.57) _uri_ &c., being read along with _chvi_ and _dach_, shows that the verb in composition with them must also be any one of the above three verbs, and none else; in order to entitle ऊरी to the name of _gati_.

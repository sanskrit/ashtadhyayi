...
Vart:- There is elision of the टि of बहिस्, and there is the affix यञ्; as बहिस् + यञ् = बाह्यः 'external'. Vart:- and the affix ईकक् may be employed. As बहिस् + ईकक् = बाहिकः 'external'. (7.2.118 किति च, there is _vriddhi_ of the first vowel when the _Taddhita_ affix has an indicatory क्). Vart:- In the _Chhandas_ it takes the affix ईकञ् as बाहिकः the difference being in the accent (6.1.197).

The word बहिस् is an अव्यय, and the above _vartika_ declares that its टि portion is elided. This very fact indicates by implication, that the टि of other _Avyayas_ need not necessarily be elided before those affixes, before which the base is called भ _bha_. In fact the following _vartika_ अव्यायानाञ्च (the टि of the _avyaya_ base is elided) given under (sutra_ (6.4.144) (the टि of the base _bha_ is elided when a _taddhita_ affix follows) is not a universal rule. Thus from the _avyaya_ आरात् we get आराती &c; here the टि is not elided.

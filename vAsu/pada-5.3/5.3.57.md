...
<<<<<<< HEAD
vRtti_eng: "The affixes _tarap_ (त॒॒र॒॒) and _iyasun_ (--ईयस्) come in the sense of 'surpassing', after a nominal stem or a finite-verb, when it expresses (comparision between ) two things, or when that which is added to it (_upapada_), is to be distinguished from another."
=======

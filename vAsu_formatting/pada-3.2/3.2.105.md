...
Why this separate _sutra_, when by aphorism (3.4.61), in the _Chhandas_ the _lun_, _lan_ and _lit_ come in all tenses ? That rule is made with regards to two or more verbs when in syntactical relation (धातुसम्बन्ध) with each other (3.4.1). The present rule is general, and without any such limitations.

...
---
This also debars _sūtra_9. By the force of the word 'optionally' used here, (2.2.9). also applies. The prohibition contained in (2.2.11). as to the compounding of a genitive with an ordinal, does not apply here; for that rule can find its scope in other ordinals than those mentioned here.

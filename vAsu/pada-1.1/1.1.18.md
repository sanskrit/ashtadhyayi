...
In some authorities the _sûtras_ (1.1.17) and (1.1.18) form but one _sūtra_, and then it is divided by the method of _yoga_-_vibhága_, the division of a single _sūtra_ into two separate _sûtras_ having two distinct rules.
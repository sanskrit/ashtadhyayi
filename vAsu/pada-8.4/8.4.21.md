...
If we could get this form by the application of the above maxim, where is the necessity of the present _sutra_? The _sutra_ is necessary in order to indicate that the above maxim is _anitya_ or not of universal application. And because it is _anitya_, that the form औजढत् is evolved by reduplicating हत् (See (8.2.1)).